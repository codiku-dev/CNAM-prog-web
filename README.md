...
- M'envoyer un lien Github (public) vers le projet à robin.lebhar@gmail.com avant le 30 juin 2025 Minuit : (en objet inscrire CEFIM-Pokedex/Nom-Prenom/Nom-Prenom) en objet
...
- Ce qui est constant devrait aller dans constant/ ( routes, constantes), ce qui est relatif aux api dans api/ etc...
